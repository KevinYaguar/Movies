...
import { editFilm } from '../utils/service';
import { Button, CircularProgress } from '@mui/material';

const FilmEditSchema = Yup.object().shape({
...
export const EditFilmsForm = ({film}) => {
  ...
  return(
      <Formik
          ...
          validationSchema={FilmEditSchema}
          onSubmit={(values) => {
              setProgress(true)
              handleSubmit(values)
          }}
